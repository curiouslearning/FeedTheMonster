...
public class SampleWebView : MonoBehaviour
{
    ...
    {
        AudioController.Instance.pausefromweb();
    }
    ...
    public void checkloaded()
    {
        if (!hasLoaded)
        {
            Debug.Log("assessment hasn't loaded, exiting");
            clickbutton();
        }
        else
        {
            Debug.Log("assessment loaded, don't need to quit");
        }
    }
    ...
    IEnumerator Start()
    {
        ...
        webViewObject.Init(
            cb: (msg) =>
            {
                ...
                if(msg == "loaded")
                {
                    //assessment did load correctly
                    hasLoaded = true;
                    AssessmentHandler.instance.MarkTestStarted();
                }
                Debug.Log("got unity call " + msg);
              //  status.text = msg;
        ...
        //webViewObject.SetURLPattern("^https://obione.io/game/fancy-assessment/*", "*", "^https://.*google.com");
